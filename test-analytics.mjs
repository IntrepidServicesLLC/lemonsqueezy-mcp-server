...
import { TOOLS, getToolDefinitions } from "./dist/tools/definitions.js";
...
const financialProps = (financialMetricsDef.inputSchema || {}).properties || {};
...
const churnProps = (churnRiskDef.inputSchema || {}).properties || {};
...
try {
  const analyticsModule = await import("./dist/tools/handlers/analytics.js");
